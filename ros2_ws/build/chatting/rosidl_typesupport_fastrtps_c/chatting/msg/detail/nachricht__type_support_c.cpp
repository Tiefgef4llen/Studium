...
#include "chatting/msg/detail/nachricht__rosidl_typesupport_fastrtps_c.h"
...
using _Nachricht__ros_msg_type = chatting__msg__Nachricht;
...
{
  const _Nachricht__ros_msg_type * ros_message = static_cast<const _Nachricht__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = chatting__msg__Nachricht;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const chatting__msg__Nachricht * ros_message = static_cast<const chatting__msg__Nachricht *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_chatting__msg__Nachricht(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  chatting__msg__Nachricht * ros_message = static_cast<chatting__msg__Nachricht *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_chatting__msg__Nachricht(cdr, ros_message);
}

static uint32_t _Nachricht__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_chatting__msg__Nachricht(
...
static size_t _Nachricht__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_chatting__msg__Nachricht(
...
static message_type_support_callbacks_t __callbacks_Nachricht = {
  "chatting::msg",
  "Nachricht",
...
static rosidl_message_type_support_t _Nachricht__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Nachricht,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chatting, msg, Nachricht)() {
  return &_Nachricht__type_support;
}
