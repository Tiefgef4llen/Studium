...
#include "chatting/msg/detail/address_book__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = chatting::msg::AddressBook;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const chatting::msg::AddressBook *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<chatting::msg::AddressBook *>(
    untyped_ros_message);
...
{
  return &chatting::msg::typesupport_fastrtps_cpp::_AddressBook__handle;
}
